...
const FooterComponent = (props) => {
    return(
        ...
        >
            ...
            <EmailShareButton><EmailIcon className="inline-block" round size={40}></EmailIcon></EmailShareButton>
            <FacebookShareButton><FacebookIcon className="inline-block ml-2" round size={40}></FacebookIcon></FacebookShareButton>
            <TwitterShareButton><TwitterIcon className="inline-block ml-2" round size={40}></TwitterIcon></TwitterShareButton>
            </div>
        </div>
    )
}
